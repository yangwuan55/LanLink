...
### Changed
- Package renamed from `com.example.lanchat.core` to `com.ymr.lancomm`
...
### Migration from com.example.lanchat.core
1. Update package imports from `com.example.lanchat.*` to `com.ymr.lancomm.*`
